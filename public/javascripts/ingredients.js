$(function() { // when DOM is fully loaded...
    ...
    $("#addIng").click(function(){
        $(".invisible").append("<input type='text' value='' name='amount_" + count + "'>");
        $(".invisible").append("<input type='text' value='' name='unit_" + count + "'>");
        $(".invisible").append("<input type='text' value='' name='ing_" + count + "'>");
        $(".invisible").append("<input type='text' value='' name='prep_" + count + "'>");
